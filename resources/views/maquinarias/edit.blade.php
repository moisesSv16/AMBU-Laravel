...
<form action="/maquinarias/{{$maquinarias->id}}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('¿Estás seguro que desea modificar el registro?')">
    ...
    <div>
        ...
        <input type="text" value="{{$maquinarias->nombre}}" id="nombre" name="nombre" class="form-control" tabindex="1">
    </div>
    <div>
        <label for="" class="form-label text-white">Descripción</label>
        <input type="text" value="{{$maquinarias->descripcion}}" id="descripcion" name="descripcion" class="form-control" tabindex="2">
    </div>
    <div>
    ...
    <div>
        ...
        <input type="number" value="{{$maquinarias->costo}}" id="costo" name="costo" class="form-control" tabindex="3">
    </div>
    <div>
        <label for="" class="form-label text-white">Imagen</label>
        <input type="file" value="{{$maquinarias->imagen}}" id="imagen" name="imagen" class="form-control col-6" tabindex="3">
        <br>
